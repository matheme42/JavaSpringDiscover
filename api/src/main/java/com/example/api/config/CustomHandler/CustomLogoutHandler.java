 ...
 * 
 * @Component annotation indicates that CustomAccessDeniedHandler is a
...
public class CustomLogoutHandler implements LogoutHandler {
    ...
    /**
     * @Autowired annotation marks the TokenRepository for automatic dependency
     *            injection by Spring.
     */
    @Autowired
    ...
    /**
     * Performs logout functionality by invalidating the token associated with the
    ...
    public void logout(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        try {
            ...
            if (storedToken != null) {
                ...
                sockets.disconnectSocketsByUsername(username);
            }
        } catch (Exception e) {
        }
    }
